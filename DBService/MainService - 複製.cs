...
namespace DBService
{
    public  class MainService_backup : ISupportedDb
    {
        ...
        public MainService UseSQLite()
        {
            ...
            _dbService = new SqliteService(_conn, _sqlProvider);
            return this;
        }
        ...
        public MainService UseMySQL()
        {
            throw new System.NotImplementedException();
        }
        public MainService UsePostgreSQL()
        {
            throw new System.NotImplementedException();
        }
        public MainService UseOracle()
        {
            _conn = new OracleConnection(_connectString);
        ...
        public TableBaseModel? GetRecordByForeignKey(string fieldName, long id, string? tableName = null)
        {
            tableName ??= _currentTableName;
            if (string.IsNullOrEmpty(tableName)) return null;
            TableBaseModel? tableResult = GetRecordByTable(tableName);
